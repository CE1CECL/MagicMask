...
**MagicMask module developers: pay extra attention!** A completely new [MagicMask Module Installer](https://github.com/topjohnwu/magicmask-module-installer) replaces the old MagicMask module template. This new format decouples **ALL** installation logic from modules, and encourages developers to use the provided API for installation. This new format is **ENFORCED**, meaning all existing modules should upgrade ASAP, and new modules are **REQUIRED** to follow the rules.

Carefully read through the [updated docs](https://topjohnwu.github.io/MagicMask/guides.html)!
