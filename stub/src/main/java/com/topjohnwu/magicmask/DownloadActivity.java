package com.topjohnwu.magicmask;

import static android.R.string.no;
import static android.R.string.ok;
import static android.R.string.yes;
import static com.topjohnwu.magicmask.R.string.dling;
import static com.topjohnwu.magicmask.R.string.no_internet_msg;
import static com.topjohnwu.magicmask.R.string.upgrade_msg;
...
import com.topjohnwu.magicmask.net.Networking;
import com.topjohnwu.magicmask.net.Request;
import com.topjohnwu.magicmask.utils.APKInstall;
...
public class DownloadActivity extends Activity {
    ...
    private static final String APP_NAME = "MagicMask";
    private static final String JSON_URL = BuildConfig.DEBUG ?
            "https://topjohnwu.github.io/magicmask-files/debug.json" :
            "https://topjohnwu.github.io/magicmask-files/canary.json";
    ...
    private void fetchCanary() {
        ...
        request(JSON_URL).getAsJSONObject(json -> {
            dialog.dismiss();
            try {
                apkLink = json.getJSONObject("magicmask").getString("link");
                showDialog();
