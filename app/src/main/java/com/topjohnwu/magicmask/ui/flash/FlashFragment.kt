...
import com.topjohnwu.magicmask.core.cmp
import com.topjohnwu.magicmask.databinding.FragmentFlashMd2Binding
...
class FlashFragment : BaseFragment<FragmentFlashMd2Binding>(), MenuProvider {
    ...
    companion object {
        ...
        private fun flashType(isSecondSlot: Boolean) =
            if (isSecondSlot) Const.Value.FLASH_INACTIVE_SLOT else Const.Value.FLASH_MAGICMASK

        /* Flashing is understood as installing / flashing magicmask itself */

        fun flash(isSecondSlot: Boolean) = MainDirections.actionFlashFragment(
            action = flashType(isSecondSlot)
        )

        /* Patching is understood as injecting img files with magicmask */
        ...
        /* Uninstalling is understood as removing magicmask entirely */
