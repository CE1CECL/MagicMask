...
import com.topjohnwu.magicmask.databinding.ComparableRv
import com.topjohnwu.magicmask.databinding.ObservableDiffRvItem
import com.topjohnwu.magicmask.databinding.addOnPropertyChangedCallback
    ...
    var state: Boolean?
        ...
        set(value) = set(value, _state, { _state = it }, BR.state) {
            if (value == true) {
                ...
                Shell.cmd("magicmask --denylist rm ${info.packageName}").submit()
...
class ProcessRvItem(
    ...
    var isEnabled
        ...
        set(value) = set(value, process.isEnabled, { process.isEnabled = it }, BR.enabled) {
            ...
            Shell.cmd("magicmask --denylist $arg $pkg \'$name\'").submit()
        }
