package com.topjohnwu.magicmask.ui.home
...
import com.topjohnwu.magicmask.arch.*
...
import com.topjohnwu.magicmask.core.download.Subject.App
...
import com.topjohnwu.magicmask.events.dialog.EnvFixDialog
import com.topjohnwu.magicmask.events.dialog.ManagerInstallDialog
import com.topjohnwu.magicmask.events.dialog.UninstallDialog
import com.topjohnwu.magicmask.ktx.await
import com.topjohnwu.magicmask.utils.Utils
import com.topjohnwu.magicmask.utils.asText
...
class HomeViewModel(
    ...
    val magicmaskTitleBarrierIds =
        intArrayOf(R.id.home_magicmask_icon, R.id.home_magicmask_title, R.id.home_magicmask_button)
    ...
    override suspend fun doLoadWork() {
        ...
        Info.getRemote(svc)?.apply {
            appState = when {
                BuildConfig.VERSION_CODE < magicmask.versionCode -> State.OUTDATED
                else -> State.UP_TO_DATE
            }

            val isDebug = Config.updateChannel == Config.Value.DEBUG_CHANNEL
            managerRemoteVersion =
                ("${magicmask.version} (${magicmask.versionCode})" +
    ...
    fun onMagicMaskPressed() = withExternalRW {
    ...
    private suspend fun ensureEnv() {
        if (magicmaskState == State.INVALID || checkedEnv) return
