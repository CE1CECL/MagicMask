...
import com.topjohnwu.magicmask.databinding.FragmentHomeMd2Binding
import com.topjohnwu.magicmask.events.RebootEvent
...
class HomeFragment : BaseFragment<FragmentHomeMd2Binding>(), MenuProvider {
    ...
    override fun onCreateView(
        ...
        with(binding.homeMagicMaskWrapper) {
            checkTitle(homeMagicMaskTitle, homeMagicMaskIcon)
        }
