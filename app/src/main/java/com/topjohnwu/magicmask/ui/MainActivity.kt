package com.topjohnwu.magicmask.ui
...
import com.topjohnwu.magicmask.core.isRunningAsStub
import com.topjohnwu.magicmask.core.model.module.LocalModule
import com.topjohnwu.magicmask.core.tasks.HideAPK
import com.topjohnwu.magicmask.databinding.ActivityMainMd2Binding
import com.topjohnwu.magicmask.ktx.startAnimations
import com.topjohnwu.magicmask.ui.home.HomeFragmentDirections
import com.topjohnwu.magicmask.utils.Utils
import com.topjohnwu.magicmask.view.MagicMaskDialog
import com.topjohnwu.magicmask.view.Shortcuts
...
class MainActivity : SplashActivity<ActivityMainMd2Binding>() {
    ...
    private fun showUnsupportedMessage() {
        if (Info.env.isUnsupported) {
            MagicMaskDialog(this).apply {
                setTitle(R.string.unsupport_magicmask_title)
                setMessage(R.string.unsupport_magicmask_msg, Const.Version.MIN_VERSION)
                setButton(MagicMaskDialog.ButtonType.POSITIVE) { text = android.R.string.ok }
                setCancelable(false)
            }.show()
        }
        ...
        if (!Info.isEmulator && Info.env.isActive && System.getenv("PATH")
                ?.split(':')
                ?.filterNot { File("$it/magicmask").exists() }
