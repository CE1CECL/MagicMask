...
import com.topjohnwu.magicmask.core.tasks.HideAPK
import com.topjohnwu.magicmask.core.utils.BiometricHelper
import com.topjohnwu.magicmask.core.utils.MediaStoreUtils
import com.topjohnwu.magicmask.core.utils.availableLocales
import com.topjohnwu.magicmask.core.utils.currentLocale
import com.topjohnwu.magicmask.databinding.DialogSettingsAppNameBinding
import com.topjohnwu.magicmask.databinding.DialogSettingsDownloadPathBinding
import com.topjohnwu.magicmask.databinding.DialogSettingsUpdateChannelBinding
import com.topjohnwu.magicmask.databinding.set
import com.topjohnwu.magicmask.ktx.activity
...
object Restore : BaseSettingsItem.Blank() {
    ...
    override fun onPressed(view: View, handler: Handler) {
        handler.onItemPressed(view, this) {
            MagicMaskDialog(view.activity).apply {
...
object MagicMask : BaseSettingsItem.Section() {
    override val title = R.string.magicmask.asText()
}
...
object DenyList : BaseSettingsItem.Toggle() {
    ...
    override var value = Config.denyList
        set(value) {
            ...
            Shell.cmd("magicmask --denylist $cmd").submit { result ->
                if (result.isSuccess) {
