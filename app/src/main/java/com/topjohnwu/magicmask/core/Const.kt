package com.topjohnwu.magicmask.core
...
object Const {
    ...
    // Paths
    const val MAGICMASK_PATH  = "/data/adb/modules"
    const val TMPDIR = "/dev/tmp"
    const val MAGICMASK_LOG = "/cache/magicmask.log"
    ...
    object Url {
        ...
        const val SOURCE_CODE_URL = "https://github.com/topjohnwu/MagicMask"

        val CHANGELOG_URL = if (APP_IS_CANARY) Info.remote.magicmask.note
        else "https://topjohnwu.github.io/MagicMask/releases/${BuildConfig.VERSION_CODE}.md"

        const val GITHUB_RAW_URL = "https://raw.githubusercontent.com/"
        const val GITHUB_API_URL = "https://api.github.com/"
        const val GITHUB_PAGE_URL = "https://topjohnwu.github.io/magicmask-files/"
    ...
    object Value {
        ...
        const val FLASH_MAGICMASK = "magicmask"
