...
import com.topjohnwu.magicmask.core.utils.MediaStoreUtils.displayName
import com.topjohnwu.magicmask.core.utils.MediaStoreUtils.inputStream
import com.topjohnwu.magicmask.core.utils.unzip
...
open class FlashZip(
    ...
    private fun flash(): Boolean {
        ...
        val isValid = runCatching {
            ...
            script.readText().contains("#MAGICMASK")
        }.getOrElse {
        ...
        if (!isValid) {
            console.add("! This zip is not a MagicMask module!")
            return false
        }
