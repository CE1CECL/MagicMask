package com.topjohnwu.magicmask.core.model.module
...
data class LocalModule(
    ...
    companion object {
        ...
        fun loaded() = RootUtils.fs.getFile(Const.MAGICMASK_PATH).exists()

        suspend fun installed() = withContext(Dispatchers.IO) {
            RootUtils.fs.getFile(Const.MAGICMASK_PATH)
                .listFiles()
                .orEmpty()
                .filter { !it.isFile && !it.isHidden }
                .map { LocalModule("${Const.MAGICMASK_PATH}/${it.name}") }
