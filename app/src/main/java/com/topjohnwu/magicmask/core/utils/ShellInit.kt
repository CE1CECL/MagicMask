package com.topjohnwu.magicmask.core.utils
...
import com.topjohnwu.magicmask.ktx.deviceProtectedContext
import com.topjohnwu.magicmask.ktx.rawResource
...
class ShellInit : Shell.Initializer() {
    override fun onInit(context: Context, shell: Shell): Boolean {
        ...
        shell.newJob().apply {
            ...
            if (shell.isRoot) {
                add("export MAGICMASKTMP=\$(magicmask --path)/.magicmask")
            ...
            if (Info.noDataExec) {
                ...
                add(
                    "if [ -x \$MAGICMASKTMP/busybox/busybox ]; then",
                    "  cp -af $localBB \$MAGICMASKTMP/busybox/busybox",
                    "  exec \$MAGICMASKTMP/busybox/busybox sh",
                    "else",
